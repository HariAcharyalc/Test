...
$sql=mysqli_query($conn,"select * from tourist where email='$e'");
...
$query="INSERT INTO `tourist`(`name`, `email`, `pass`, `mobile`, `gender`, `image`, `dob`) VALUES('$n', '$e', '$pass', '$mob', '$gen', '$imageName', '$dob')";
