    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/night.jpg');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/phewalake.jpg');"></div>
                <div class="carousel-caption">
			 ...
			 <div class="item">
                <div class="fill" style="background-image:url('images/Davidfall.jpg');"></div>
                <div class="carousel-caption">
...
Before we can look into the php code, you need to create a database called "feed" with two tables in it..one as student and another one as take
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed By TIS Group</span>
	</div>
    <!-- jQuery -->
