...
mysqli_query($conn,"INSERT INTO contact (`name`, `email`, `mobile`, `message`) values('$n','$e','$m','$msg')");
...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h3><font color="#000">Contact Us </font></h3>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Pokhara-7, Simalchour<br>Kaski, Nepal<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>:(+977) 9802802771</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:tisgroup@gmail.com">tisgroup@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: Sunday - Friday: 10:00 AM to 7:00 PM</p>
