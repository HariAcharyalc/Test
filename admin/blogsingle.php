...
<head>
  ...
  <!-- Bootstrap Core CSS -->
    ...
    <!-- Custom CSS -->
    <link href="../ss/modern-business.css" rel="stylesheet">
             ...
             $id=$_GET['title'];
              ...
              if ($queryResult >0) {
                ...
                echo'
                  ...
                  <p>'.$row['b_short'].'</p>
                  <p>
                  <a href="'.$row['image'].'"><img src="'.$row['image'].'" alt="Image???" class="img-fluid"></a>
                  </p>
                  <p>'.$row['b_long'].'</p>
                  <div>
                                    <a href="https://www.google.com/maps/place/Kaski"><i class="fa fa-arrow-right"></i> Find Route</a>
                                    </div>
